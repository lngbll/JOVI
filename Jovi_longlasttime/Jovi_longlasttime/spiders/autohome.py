...
import scrapy
from Jovi_longlasttime.items import create_item_class
...
class AutohomeSpider(scrapy.Spider):
    ...
    def get_second_tag(self,response):
        ...
        if flag:
            ...
            for i in thirdTags:
                ...
                url = 'https://www.autohome.com.cn/ashx/channel/AjaxChannelArtList.ashx?20&page=1&class2Id={}'.format(classID)
    ...
    def get_pages(self,response):
        ...
        for i in range(1,pages+1):
            page = 'https://www.autohome.com.cn/ashx/channel/AjaxChannelArtList.ashx?20&page={}&class2Id={}'.format(i,meta['classId'])
    ...
    def parse_json(self,response):
        ...
        for article in articles:
            ...
            url = 'https://www.autohome.com.cn{}{}/{}.html'.format(article['Dir'],article['PublishTime'],article['Id'])
