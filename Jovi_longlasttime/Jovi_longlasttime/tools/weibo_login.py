...
class weibo_login(object):
    ...
    def gen_rsa_sp(self):
        ...
        message = '{}\t{}\n{}'.format(self.pre_login_info.get('servertime'),self.pre_login_info.get('nonce'),self.pwd).encode()
    ...
    def pre_login(self):
        try:
            ...
            r= self.session.get('https://login.sina.com.cn/sso/prelogin.php?entry=weibo&callback=sinaSSOController.preloginCallBack&su=&rsakt=mod&client=ssologin.js(v1.4.19)&_=1567405550547')
            r.raise_for_status()
